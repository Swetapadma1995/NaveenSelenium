...
public class MultiSelectDropDownHandling {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//selectDropDownMultipleValues(dropDownLocator, optionLocator, "Lesser flamingo" , "Chilean flamingo" , "James's flamingo");
		//TC 2. Single values 
		//selectDropDownMultipleValues(dropDownLocator,optionLocator, "Lesser flamingo");
		//TC 3. All values
